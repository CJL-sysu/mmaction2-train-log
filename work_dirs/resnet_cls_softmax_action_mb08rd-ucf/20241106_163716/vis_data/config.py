...
test_dataloader = dict(
    ...
    dataset=dict(
        ...
        data_prefix=dict(
            img='/home/node1/Desktop/code/ai/data/ucf101/ucf_MvMbRd/ucf_a_0_8b'
        ),
...
train_cfg = dict(
    max_epochs=250, type='EpochBasedTrainLoop', val_begin=1, val_interval=1)
...
work_dir = './work_dirs/resnet_cls_softmax_action_mb08rd-ucf'
