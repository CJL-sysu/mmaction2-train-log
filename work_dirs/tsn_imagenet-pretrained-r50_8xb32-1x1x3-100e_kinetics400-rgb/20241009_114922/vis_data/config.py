...
launcher = 'none'
load_from = 'work_dirs/tsn_imagenet-pretrained-r50_8xb32-1x1x3-100e_kinetics400-rgb/best_acc/top1_epoch_6.pth'
log_level = 'INFO'
...
train_dataloader = dict(
    ...
    dataset=dict(
        ...
        data_prefix=dict(video='data/kinetics400_tiny/train'),
        pipeline=[
            dict(io_backend='disk', type='DecordInit'),
            dict(
