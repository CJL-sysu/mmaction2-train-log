...
test_dataloader = dict(
    ...
    dataset=dict(
        ann_file=
        '/home/node1/Desktop/code/ai/data/sbu/nc_plus_08size_3c_filter/Privacy-zqf/valPrivacyRaw.txt',
        data_prefix=dict(
            img=
...
train_dataloader = dict(
    ...
    dataset=dict(
        ann_file=
        '/home/node1/Desktop/code/ai/data/sbu/nc_plus_08size_3c_filter/Privacy-zqf/trainPrivacyRaw.txt',
        data_prefix=dict(
            img=
            '/home/node1/Desktop/code/ai/data/sbu/nc_plus_08size_3c_filter/data'
        ),
